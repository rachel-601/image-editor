...
void TestChainRenderCopy() {
	cout << "Entered TestChainRenderCopy." << endl;
	// load a PNG file
	PNG alphabetpng;
	alphabetpng.readFromFile("images-original/alphabet-240x40.png");
	...
	cout << "Rendering Chain to output PNG with 4 columns... ";
	PNG alphabetcopy = c1.Render(4, true);
	cout << "done." << endl;

	cout << "Writing output PNG to file... ";
	alphabetcopy.writeToFile("images-output/alphabet-240x40-copy-render3-full.png");
	cout << "done." << endl;

	cout << "Leaving TestChainRenderCopy..." << endl;
}

void TestDiffImage() {
	PNG shanghaiPNG;
	shanghaiPNG.readFromFile("images-original/shanghai.JPG");
	Chain c(shanghaiPNG, 40);
	c.Blockify();
	PNG shanghaiBlock = c.Render(3, true);
	shanghaiBlock.writeToFile("images-output/shanghai-output.png");
}